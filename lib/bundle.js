...
(function (global, factory) {
    ...
    */
    ...
    keys(INHERITABLE_STYLE_ATTRIBUTES_MAP);
    var SELF_STYLE_ATTRIBUTES_MAP = {
        'alignment-baseline': 'textBaseline',
        'stop-color': 'stopColor'
    };
    keys(SELF_STYLE_ATTRIBUTES_MAP);
    ...
    function pushTokens(block, str, style, wrapInfo, styleName) {
        ...
        if (wrapInfo) {
            ...
            if (tokenStyle.width != null && tokenStyle.width !== 'auto') {
                var outerWidth = parsePercent(tokenStyle.width, wrapInfo.width) + tokenPaddingH;
                if (lines.length > 0) {
    ...
    var ZRText = (function (_super) {
        ...
        ZRText.prototype._updatePlainTexts = function () {
            ...
            if (needDrawBg || textPadding) {
                var outerWidth = contentBlock.width;
    ...
    (function (VertexType) {
        VertexType["NONE"] = "";
        VertexType["EVENT"] = "event";
        VertexType["PROCESS"] = "process";
        VertexType["DECISION"] = "decision";
        VertexType["GROUP"] = "group";
        VertexType["CONFLUENCE"] = "confluence";
        VertexType[VertexType["EVENT_START"] = 1] = "EVENT_START";
        VertexType[VertexType["EVENT_OVER"] = 2] = "EVENT_OVER";
        VertexType[VertexType["PROCESS_WORKFLOW"] = 1] = "PROCESS_WORKFLOW";
        VertexType[VertexType["PROCESS_ACTION"] = 2] = "PROCESS_ACTION";
        VertexType[VertexType["PROCESS_MANUAL"] = 3] = "PROCESS_MANUAL";
        VertexType[VertexType["PROCESS_SCRIPT"] = 4] = "PROCESS_SCRIPT";
    })(VertexType || (VertexType = {}));
    var VertexStatus;
    (function (VertexStatus) {
        VertexStatus["NONE"] = "";
        VertexStatus["ACTIVE"] = "active";
        VertexStatus["ERROR"] = "error";
        VertexStatus["PROCESS"] = "process";
        VertexStatus["CANCEL"] = "cancel";
        VertexStatus["SUCCESS"] = "success";
        VertexStatus["PAUSE"] = "pause";
        VertexStatus["DISABELD"] = "disabled";
    })(VertexStatus || (VertexStatus = {}));
    var VertexButtonType;
    (function (VertexButtonType) {
        VertexButtonType["OUTER"] = "outer";
        VertexButtonType["INNER"] = "inner";
    })(VertexButtonType || (VertexButtonType = {}));
    ...
    var BaseView = (function () {
        ...
        BaseView.prototype.renderOuterButtons = function (btnStyle) {
            ...
            if (type !== VertexButtonType.OUTER || !buttons.length)
                return;
            ...
            buttons.forEach(function (btn, index) {
                var g = new Group({ x: 0, y: index * 30 });
                g.add(new Circle({ shape: { cx: 10, cy: 10, r: 10 }, style: { fill: background, stroke: border } }));
                var icon = new ZRText({ style: __assign(__assign({}, btn.icon.style), { fontSize: 14, fill: color, x: 10, y: 10 }) });
                g.add(icon);
    ...
    var ProcessView = (function (_super) {
        ...
        ProcessView.prototype.renderText = function () {
            ...
            this.text = lines.map(function (line, index) {
                ...
                var t = new ZRText({ style: __assign({ y: start + index * lineHeight, text: line }, tStyle) });
                _this.view.add(t);
                return t;
            });
        };
        ProcessView.prototype.renderTypeIcon = function () {
            ...
            if (!icon)
                return;
            icon = new ZRText({ style: __assign(__assign({}, icon.style), { fill: color }) });
            this.view.add(icon);
        };
    ...
    var VertexModel = (function (_super) {
        ...
        function VertexModel(type, attribute, theme) {
            ...
            _this.theme = theme;
            _this.status = VertexStatus.NONE;
            _this.createView();
            return _this;
        }
        VertexModel.prototype.handleClick = function () {
            if (this.status === VertexStatus.ACTIVE)
                return;
    ...
    var Container = (function () {
        ...
        Container.prototype.createIcon = function (fontFamily, text, x, y) {
            if (x === void 0) { x = 12; }
            if (y === void 0) { y = 12; }
            var icon = new ZRText({ style: { fontFamily: fontFamily, text: text, x: x, y: y, align: 'center', verticalAlign: 'middle', fontSize: 16 } });
            return icon;
        };
