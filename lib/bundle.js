...
(function (global, factory) {
    ...
    */
    ...
    var BaseView = (function () {
        ...
        BaseView.prototype.setConnectors = function () {
            var _this = this;
    ...
    var Process = (function (_super) {
        ...
        Process.prototype.setText = function () {
            var _a = this.attribute, text = _a.text, width = _a.width, height = _a.height;
            var vertex = this.theme.vertex;
            if (typeof text === 'string') {
                this.text = new ZRText({
                    style: { x: width / 2, y: height / 2, text: text, fill: vertex.text, align: 'center', verticalAlign: 'middle' },
                });
            }
            this.group.add(this.text);
        };
        Process.prototype.setTypeIcon = function () {
            var vertex = this.theme.vertex;
        ...
        Process.prototype.setBackground = function () {
    ...
    var Container = (function () {
        ...
        Container.prototype.addVertex = function (type, attribute) {
        ...
        Container.prototype.createIcon = function (fontFamily, text, x, y) {
            if (x === void 0) { x = 16; }
            if (y === void 0) { y = 16; }
            return new ZRText({ style: { fontFamily: fontFamily, text: text, x: x, y: y, align: 'center', verticalAlign: 'middle', fontSize: 16 } });
        };
