...
(function (global, factory) {
    ...
    */
    ...
    var BaseView = (function () {
        function BaseView(attribute, style) {
            this.style = style;
            this.attribute = attribute;
            this.buttons = [];
            this.childViews = [];
            this.view = new Group$1({ x: attribute.x, y: attribute.y, draggable: true });
            this.initEvents();
        }
        ...
        BaseView.prototype.update = function (type, value) { };
        BaseView.prototype.renderConnectors = function (connectorStyle) {
            var _this = this;
            if (connectorStyle === void 0) { connectorStyle = {}; }
            var border = connectorStyle.border, background = connectorStyle.background;
            var points = generateConnectPoints(this.attribute);
        ...
        BaseView.prototype.renderOuterButtons = function (btnStyle) {
            var _this = this;
            if (btnStyle === void 0) { btnStyle = {}; }
            var buttons = this.buttons.filter(function (b) { return b.type === "outer"; });
            if (!buttons.length)
                return;
            var color = btnStyle.color, border = btnStyle.border, background = btnStyle.background;
            var _a = this.attribute, width = _a.width, height = _a.height;
    ...
    var ConfluenceView = (function (_super) {
        ...
        ConfluenceView.prototype.render = function (styles) {
    ...
    var EventView = (function (_super) {
        ...
        EventView.prototype.render = function (styles) {
            this.renderBackground();
            this.renderText();
            this.renderConnectors(styles[0]);
            this.renderOuterButtons(styles[1]);
    ...
    var GroupView = (function (_super) {
        ...
        GroupView.prototype.renderBackground = function () {
            var _a = this.style, border = _a.border, background = _a.background;
            var height = this.attribute.height;
        ...
        GroupView.prototype.renderHeader = function () {
            var _a = this.attribute, icon = _a.icon, text = _a.text;
            var _b = this.style.header, color = _b.color, background = _b.background;
        ...
        GroupView.prototype.renderGroupButtons = function () {
            ...
            if (!buttons.length)
                return;
            var _a = this.style.button, color = _a.color, background = _a.background;
            var bgLen = 24;
            buttons.forEach(function (item, index) {
                var icon = item.icon, handler = item.handler;
        ...
        GroupView.prototype.render = function (styles) {
            this.renderBackground();
            this.renderHeader();
    ...
    var GroupItemView = (function (_super) {
        ...
        GroupItemView.prototype.update = function (type, value) {
            if (type === "attribute") {
        ...
        GroupItemView.prototype.renderText = function () {
            var _this = this;
            var _a = this.attribute, text = _a.text, width = _a.width, height = _a.height;
    ...
    var VertexModel = (function (_super) {
        ...
        function VertexModel(type, attribute, theme) {
            if (attribute === void 0) { attribute = {}; }
            var _this = _super.call(this) || this;
            _this.children = [];
            _this.isGroup = false;
            _this.type = type;
            _this.attribute = Object.assign({}, { x: 10, y: 10, width: V_WIDTH, height: V_HEIGHT }, attribute);
            _this.theme = theme;
            _this.status = "";
            _this.isGroup = type === "group";
            if (type === "event" || type === "confluence") {
                _this.attribute.width = V_HEIGHT;
            }
            if (type === "group") {
                _this.attribute.width = G_WIDTH;
                _this.attribute.height = G_HEIGHT;
            }
            if (type === "group_item") {
                _this.attribute.width = G_WIDTH - (G_PADDING + 1) * 2;
                _this.attribute.height = G_ITEM_HEIGHT;
            }
            _this.createView();
            return _this;
        }
        ...
        VertexModel.prototype.createView = function () {
            var _this = this;
        ...
        VertexModel.prototype.setAttribute = function (attribute) {
            this.attribute = Object.assign({}, this.attribute, attribute);
            this.view.update("attribute", this.attribute);
        };
        ...
        VertexModel.prototype.render = function () {
            var _a = this.theme, vertex = _a.vertex, connector = _a.connector;
    ...
    var Container = (function () {
        ...
        Container.prototype.addVertex = function (type, attribute, buttons) {
            var v = new VertexModel(type, attribute, this.theme);
            v.setContainer(this);
            if (buttons) {
        ...
        Container.prototype.addGroupItem = function (id, attribute, buttons) {
            var v = this.graph.getVertex(id);
            if (!v.isGroup)
                return;
            var i = new VertexModel("group_item", attribute, this.theme);
            i.setContainer(this);
            if (buttons) {
