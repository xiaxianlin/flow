...
(function (global, factory) {
    ...
    */
    ...
    var BaseView = (function () {
        function BaseView(attribute, theme) {
            var _this = this;
            this.theme = theme;
            this.attribute = attribute;
            this.group = new Group({ x: attribute.x, y: attribute.y, draggable: true });
            this.group.on('mouseover', function () { return _this.handleMouseOver(); });
            this.group.on('mouseout', function () { return _this.handleMouseLeave(); });
            this.group.on('click', function () { return _this.handleClick(); });
            this.group.on('dbclick', function () { return _this.handleDBClick(); });
            this.group.on('drop', function () {
                console.log(_this.group);
            });
        }
        BaseView.prototype.handleMouseOver = function () {
            this.connectors.forEach(function (c) { return c.attr('style', { opacity: 1 }); });
            this.buttonLayer.show();
        };
        BaseView.prototype.handleMouseLeave = function () {
            this.connectors.forEach(function (c) { return c.attr('style', { opacity: 0 }); });
            this.buttonLayer.hide();
        };
        BaseView.prototype.handleClick = function () { };
        BaseView.prototype.handleDBClick = function () { };
        BaseView.prototype.setButtons = function (buttons) {
            this.buttons = buttons;
        };
        BaseView.prototype.renderConnectors = function () {
            var _this = this;
            var _a = this.theme.connector, border = _a.border, background = _a.background;
        ...
        BaseView.prototype.renderOuterButtons = function () {
            ...
            if (type !== VertexButtonType.OUTER || !buttons.length)
                return;
            var vertex = this.theme.vertex;
            var _b = vertex.button, text = _b.text, border = _b.border, background = _b.background;
            var _c = this.attribute, width = _c.width, height = _c.height;
            ...
            buttons.forEach(function (btn, index) {
                ...
                var icon = new ZRText({ style: __assign(__assign({}, btn.icon.style), { fontSize: 14, fill: text, x: 10, y: 10 }) });
                g.add(icon);
    ...
    var Process = (function (_super) {
        ...
        Process.prototype.renderText = function () {
            var _this = this;
            var _a = this.attribute, text = _a.text, width = _a.width, height = _a.height;
            var vertex = this.theme.vertex;
            var lines = cutText(text, FONT_SIZE, width - 40);
            var tStyle = { x: width / 2, fill: vertex.text, align: 'center', verticalAlign: 'middle', fontSize: FONT_SIZE };
        ...
        Process.prototype.renderTypeIcon = function () {
            var vertex = this.theme.vertex;
            var icon = this.attribute.icon;
            if (!icon)
                return;
            icon = new ZRText({ style: __assign(__assign({}, icon.style), { fill: vertex.text }) });
            this.group.add(icon);
        };
        Process.prototype.renderBackground = function () {
            var _a = this.attribute, width = _a.width, height = _a.height;
            var _b = this.theme.vertex, border = _b.border, background = _b.background;
    ...
    var Vertex = (function () {
        function Vertex(type, attribute, theme) {
        ...
        Vertex.prototype.createView = function () {
            switch (this.type) {
        ...
        Vertex.prototype.setGroupId = function (gid) {
            this.groupId = gid;
        };
        ...
        Vertex.prototype.setButtons = function (buttons) {
    ...
    var Container = (function () {
        function Container(container, width, height) {
            ...
            this.render.on('click', function (evt) {
        ...
        Container.prototype.addVertex = function (type, attribute, buttons) {
            var v = new Vertex(type, attribute, this.theme);
            if (buttons) {
                v.setButtons(buttons);
            }
            this.graph.addVertex(v);
            var view = v.getView().render();
